...
from numpy import frompyfunc, vectorize, zeros, uint8, uint32, array, concatenate, add, argmin, arange, column_stack, unique, split, empty, ix_, take
...
if __debug__:
    _global_tracking_data = defaultdict(lambda: dict(moments=[], last_start=None))
