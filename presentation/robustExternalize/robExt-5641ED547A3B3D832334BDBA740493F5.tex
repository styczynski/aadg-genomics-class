...
f_out_write = open("robExt-5641ED547A3B3D832334BDBA740493F5-out.tex", "w")
...
for program_label, program_stats in stats.items():
  if program_label in program_label_mapping:
    ...
    rects = ax.bar(x + offset, dict(
      start=[program_stats[case]["read_bwt_pad_begin"]["t_total"] for case in cases],
