...
f_out_write = open("robExt-B6D83AA7902D3DEAD844554796CDD9BA-out.tex", "w")
...
for program_label, program_stats in stats.items():
    ...
    rects = ax.bar(x + offset, [program_stats[case]["read_bwt"]["t_avg"] for case in cases], width, label=program_label)
