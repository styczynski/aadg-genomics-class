...
f_out_write = open("robExt-3E4408EDDDEEBF423747F7FE541D6828-out.tex", "w")
...
cases = ["20Ma", "20Mb", "small_reads2", "small_reads1", "small_reads0"]
...
for program_label, program_stats in stats.items():
  if program_label in program_label_mapping:
    ...
    vals_read_bwt = [(program_stats[case]["read_bwt"]["t_total"] if "read_bwt" in program_stats[case] else 0) for case in cases]
    vals_read_dp = [(program_stats[case]["read_dp"]["t_total"] if "read_dp" in program_stats[case] else 0) for case in cases]
