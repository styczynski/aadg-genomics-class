...
f_out_write = open("robExt-78866BF5BEDCB218A34F1E7F723CDE97-out.tex", "w")
...
program_label_mapping = {
  ...
  "bwt-fragment-02p01": "Fragment 20% (ER 10%)",
  "bwt-fragment-03p006": "Fragment 30% (ER 6%)",
  "bwt-fragment-03p008": "Fragment 30% (ER 8%)",
}
width = 0.25
multiplier = 0
...
for program_label, program_stats in stats.items():
  if program_label in program_label_mapping:
    ...
    rects = ax.bar(x + offset, vals_start, width, hatch="0", label=f"{program_label_mapping[program_label]} (start)", color=color_per_solution[program_label], edgecolor=color_per_solution[program_label])
    ax.bar(x + offset, vals_end, width, bottom=vals_start, hatch="//", color="white", edgecolor=color_per_solution[program_label], label=f"{program_label_mapping[program_label]} (end)")
...
ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05),
    ncol=3, fancybox=True, shadow=True, title='Program', prop={'size': 6})
