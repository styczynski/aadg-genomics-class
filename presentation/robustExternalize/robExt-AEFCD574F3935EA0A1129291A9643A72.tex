...
f_out_write = open("robExt-AEFCD574F3935EA0A1129291A9643A72-out.tex", "w")
...
for program_label, program_stats in stats.items():
  if program_label in program_label_mapping:
    ...
    ax.bar(x + offset, vals_index_target, width, bttom=vals_index_query,  color="#107AB0", label=f"{program_label_mapping[program_label]}: Index target")
